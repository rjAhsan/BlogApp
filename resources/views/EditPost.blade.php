                    ...
                    <div class="card-body">
                        <form method="POST" action="#">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" value=""  type="text" class="form-control @error('name') is-invalid @enderror" name="Title"  required  >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="Catagorie">
                                            ...
                                            <option value="$Catagorie->id"></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                   <textarea class="form-control" rows="10" cols="100" name="Body" value="" requried>
                                       Write
                                       Your
                                       Article
                                       here........
